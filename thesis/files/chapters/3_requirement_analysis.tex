...
\subsection{UC7: Visualizzazione del modello associato dell'alert}
\label{uc:uc7}
\begin{itemize}
    \item \textbf{Attori:} Utente.
    \item \textbf{Precondizioni:} 
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
        \begin{enumerate}
            ...
            \item Il modulo XAI elabora le informazioni ricevute.
...
\rowcolors{2}{lightblue}{white}
    \begin{longtable}{|l|p{0.42\textwidth}|l|l|}
        ...
        \hline
        \textbf{RFN-18} & Visualizzazione del modello associato dell'alert & UC7 & N \\
        \hline
