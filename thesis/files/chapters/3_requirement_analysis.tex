...
\rowcolors{2}{lightblue}{white}
    \begin{longtable}{|l|p{0.42\textwidth}|l|l|}
        ...
        \textbf{RFN-1} & Configurazione del modulo XAI & UC1 \\
        \hline
        \textbf{RFN-2} & Selezione del modello LLM per il modulo XAI & UC1.1  \\
        \hline
        \textbf{RFN-3} & Configurazione degli utenti abilitati al modulo XAI & UC1.2  \\
        \hline
        \textbf{RFN-4} & Configurazione dei tool disponibili per il modulo XAI & UC1.3  \\
        \hline
        \textbf{RFN-5} & Richiesta di spiegazioni al modulo XAI su una decisione del sistema & UC2\\
        \hline
        \textbf{RFN-6} & Gestione della conversazione con il modulo XAI & UC2.1 \\
        \hline
        \textbf{RFN-7} & Chiamata a tool per spiegazioni del modulo XAI & UC2.2 \\
        \hline
        \textbf{RFN-8} & Modello LLM non raggiungibile & UC2.3  \\
        \hline
        \textbf{RFN-9} & Limite token di risposta superato & UC2.4 \\
        \hline
        \textbf{RFN-10} & Permessi non sufficienti per effettuare la richiesta & UC2.5  \\
        \hline
        \textbf{RFN-11} & Richiesta creazione nuovi record & UC3  \\
        \hline
        \textbf{RFN-12} & Chiamata al tool per creazione record del modulo XAI & UC3.1  \\
        \hline
        \textbf{RFN-13} & Dati forniti incorretti per la creazione del record & UC3.2 \\
        \hline
        \textbf{RFN-14} & Configurazione delle regole alert & UC4  \\
        \hline
        \textbf{RFN-15} & Visualizzazione delle notifiche alert & UC5  \\
        \hline
        \textbf{RFN-16} & Numero elevato di violazioni rilevate & UC5.1  \\
        \hline
        \textbf{RFN-17} & Visualizzazione del dettaglio dell'alert & UC6  \\
        \hline
        \textbf{RFN-18} & Visualizzazione del modello associato all'alert & UC7  \\
        \hline
        \textbf{RFN-19} & Richiesta al modulo XAI di una spiegazione relativa all'alert generato & UC8 \\
        \hline
        \textbf{RFN-20} & Visualizzazione log operazioni & UC9 \\
        \hline
        \textbf{RFN-21} & Visualizzazione dei dettagli di un'operazione & UC10\\
        \hline
    \end{longtable}
