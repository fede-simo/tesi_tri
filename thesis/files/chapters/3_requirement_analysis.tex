...
\label{uc:uc5}
    \begin{itemize}
        ...
        \item \textbf{Scenario principale:}
            ...
            \end{enumerate}
        \item \textbf{Scenario alertnativo:}
            \begin{enumerate}
...
\subsection{UC6: Visualizzazione dell'alert}
\label{uc:uc6}
\begin{itemize}
    \item \textbf{Attori:} Utente.
    \item \textbf{Precondizioni:} 
...
\begin{center}
    \keepXColumns
    \rowcolors{2}{lightblue}{white}
        \begin{longtable}{|l|p{0.55\textwidth}|l|l|}
            \hline
            \rowcolor{gold}
            ...
            \hline
            \textbf{RFN-17} & Visualizzazione dell'alert & UC6 & N \\
            \hline
...
\begin{center}
    ...
    \rowcolors{2}{lightblue}{white}
        \begin{longtable}{|l|p{0.55\textwidth}|l|l|}
            ...
            \textbf{RQN-1} & Il sistema deve garantire tempi di risposta adeguati nell'interazione con il modulo XAI, evitando attese non necessarie da parte dell'utente & UC1 - UC3.2 & N \\
            \hline
            ...
            \hline
            \textbf{RQN-6} & Il sistema deve notificare tempestivamente l'utente in caso di eccezioni nell'uso di modulo XAI e alert per ridurre le attese inutili & UC2.3 - UC2.4, UC5.1 & N \\
        \end{longtable}
\end{center}
...
\begin{center}
    ...
    \rowcolors{2}{lightblue}{white}
        \begin{longtable}{|l|p{0.55\textwidth}|l|l|}
            ...
            \hline
            \textbf{RVN-3} & Il modulo XAI deve fornire le spiegazioni generate in lingua italiana & UC1 - UC3.2 & N \\
            \hline
            \textbf{RVN-4} & L'integrazione con i modelli linguistici deve avvenire attraverso le API messe a disposizione dai relativi provider & UC1 - UC3.2 & N \\
            \hline
        \end{longtable}
\end{center}
